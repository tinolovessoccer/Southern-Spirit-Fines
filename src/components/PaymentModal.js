      ...
      <div className="modal" style={{ textAlign: 'center' }}>
        ...
        <div style={{ background: '#0b1f3a', border: '1.5px solid var(--blue)', borderRadius: 10, padding: 24, textAlign: 'left', marginBottom: 14 }}>
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ fontWeight: 700, fontSize: 16 }}>⚽ {PAYMENT_INFO.accountName}</div>
          </div>
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 18, color: 'var(--sky)', letterSpacing: 1 }}>
              BSB: {PAYMENT_INFO.bsb} · Account: {PAYMENT_INFO.account}
            </div>
            <div style={{ fontSize: 11, color: 'var(--muted)', marginTop: 3 }}>← Update in src/constants.js with real details</div>
          </div>
          <div>
            <div style={{ fontSize: 10, color: 'var(--muted)', letterSpacing: 1.5, marginBottom: 4 }}>REFERENCE</div>
            <div style={{ fontWeight: 600, fontSize: 14, color: 'var(--green)' }}>{PAYMENT_INFO.reference}</div>
          </div>
        </div>
